...
type Service interface {
	GetMonitorByTeamID(ctx context.Context, monitorID uint64) (*entities.HttpResult, error)
...
func (s *ServiceImpl) GetMonitorByTeamID(ctx context.Context, monitorID uint64) (*entities.HttpResult, error) {
